...
},{}],"Config/readConfig.js":[function(require,module,exports) {
"use strict";
...
},{"./declaration.js":"Config/declaration.js"}],"Config/communication.js":[function(require,module,exports) {
"use strict";
...
},{"./declaration.js":"Config/declaration.js"}],"Config/createTable.js":[function(require,module,exports) {
"use strict";
...
function _writeToNfcTag() {
  _writeToNfcTag = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _nfcWriter;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return _nfcWriter.write(_buildConfig.data);
        case 5:
          console.log("Erfolgreich geschrieben: \"".concat(_buildConfig.data, "\" auf den NFC-Tag."));
